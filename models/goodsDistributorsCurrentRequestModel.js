...
const GoodsDistributorsCurrentRequestSchema = new mongoose.Schema(
    {
        ...
        arrivalAddress: {// retailer address
            street: {
                type: String,
                required: true,
                trim: true,
        ...
        departureAddress: {// distributor address
            street: {
                type: String,
                trim: true,
                lowercase: true,
...
//2- create model
const GoodsDistributorsCurrentRequestModel = mongoose.model('Goods-Distributors-Current-Request', GoodsDistributorsCurrentRequestSchema);

module.exports = GoodsDistributorsCurrentRequestModel